...
update ecmc_sys_authority set name='备案查询' where id='40289305591b912301591bccaebd0246';
update ecmc_sys_authority set name='备案修改' where id='402893ef592463e9015924711a880000';
update ecmc_sys_authority set name='备案删除' where id='402893ef592463e901592471f0760001';


update ecmc_sys_menu set name= '备案管理' where id='40289361591b889401591b8ac4a30000';


update sys_selfpower set power_name='备案中心'   ,power_desc='备案中心'   where power_sort=270000 ;
update sys_selfpower set power_name='开始备案'   ,power_desc='开始备案'   where power_sort=271000 ;
update sys_selfpower set power_name='新增备案'   ,power_desc='新增备案'   where power_sort=271010 ;
update sys_selfpower set power_name='已备案列表' ,power_desc='已备案列表' where power_sort=271011 ;
update sys_selfpower set power_name='新增接入'   ,power_desc='新增接入'   where power_sort=271012 ;
update sys_selfpower set power_name='新增网站'   ,power_desc='新增网站'   where power_sort=271013 ;
update sys_selfpower set power_name='变更备案'   ,power_desc='变更备案'   where power_sort=271014 ;



update sys_selfpower set parent_id='3b4b2df2f29211e68b1e52540060f093' where power_sort=271000 ;
update sys_selfpower set parent_id='3b4bce88f29211e68b1e52540060f093' where power_sort=271010 ;
update sys_selfpower set parent_id='3b4bce88f29211e68b1e52540060f093' where power_sort=271011 ;
update sys_selfpower set parent_id='3b4bce88f29211e68b1e52540060f093' where power_sort=271012 ;
update sys_selfpower set parent_id='3b4bce88f29211e68b1e52540060f093' where power_sort=271013 ;
update sys_selfpower set parent_id='3b4bce88f29211e68b1e52540060f093' where power_sort=271014 ;
