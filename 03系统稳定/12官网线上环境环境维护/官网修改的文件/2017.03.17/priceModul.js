			...
			spaceSelect:function(value,timesS){
				if(value == 'GB'){
					if(timesS<=1){
						...
						return (1024 - 1) * 0.158 + (timesS - 1024) * 0.151;
					}else if(timesS > 51200){
						return (1024 -1) * 0.158 + ( 51200 - 1024 ) * 0.151 + ( timesS - 51200 ) * 0.144;
					}
				}else{
					if(timesS<=1){
						return timesS * 0.158 * ( 1024 - 1 );
					}else if(timesS > 1 & timesS <= 50){
						return (timesS * 1024 - 1 * 1024) * 0.151   +  0.158 * ( 1024 - 1 );
					}else if(timesS > 50){
						return 0.151 * 49 * 1024 + ( timesS * 1024 - 50 * 1024 ) * 0.144  +  0.158 * (1024 -1 ) ;
					}
				}
			},				
